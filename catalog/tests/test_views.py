...
class RenewBookInstancesViewTest(TestCase):
	...
	def setUp(self):
		...
		self.test_bookinstance1=BookInstance.objects.create(book=test_book, imprint="Imprint, 2016", due_back=return_date, borrower=test_user1, status='o')

		#Create a BookInstance object for test_user2
		return_date = datetime.date.today() + datetime.timedelta(days=5)
		self.test_bookinstance2=BookInstance.objects.create(book=test_book, imprint='Imprint, 2016', due_back=return_date, borrower=test_user2, status='o')
	...
	def test_redirects_to_all_borrowed_book_list_on_success(self):
		...
		self.assertRedirects(resp, reverse('librarian-borrowed'))
...
class AuthorCreateViewTest(TestCase):
	...
	def test_only_borrowed_books_in_list(self):
		...
		self.assertEqual(len(resp.context['author_list']),0)

		resp = self.client.post(reverse('author-create'), {'first_name':'Albert', 'last_name':'Han'})

		resp = self.client.get(reverse('authors'))
		self.assertEqual(resp.status_code, 200)
		self.assertTrue('Han, Albert' in str(resp.context['author_list']))
...
test_author = Author.objects.create(first_name='John', last_name='Smith')
resp = client.get(reverse('author-create'))
'''
